...
class STIG_Ubuntu2004_SV_238280r654015 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238280r654015')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the newgrp command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238280r654015'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238280r654015.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238280r654015.sh"}]
  end
end
