...
class STIG_Ubuntu2004_SV_238343r654204 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238343r654204')
    @title = 'The Ubuntu operating system must configure /var/log/syslog file with mode 0640 or less permissive.'
    @scored = true
    @level = 1
    @identifier = 'SV_238343r654204'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238343r654204.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238343r654204.sh"}]
  end
end
