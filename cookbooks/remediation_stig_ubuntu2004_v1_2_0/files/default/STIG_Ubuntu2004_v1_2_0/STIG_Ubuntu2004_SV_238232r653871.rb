...
class STIG_Ubuntu2004_SV_238232r653871 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238232r653871')
    @title = 'The Ubuntu operating system must electronically verify Personal Identity Verification (PIV) credentials.'
    @scored = true
    @level = 1
    @identifier = 'SV_238232r653871'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238232r653871.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238232r653871.sh"}]
  end
end
