...
class STIG_Ubuntu2004_SV_238340r654195 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238340r654195')
    @title = 'The Ubuntu operating system must configure the /var/log directory to have mode 0750 or less permissive.'
    @scored = true
    @level = 1
    @identifier = 'SV_238340r654195'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238340r654195.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238340r654195.sh"}]
  end
end
