...
class STIG_Ubuntu2004_SV_238339r654192 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238339r654192')
    @title = 'The Ubuntu operating system must configure the /var/log directory to be owned by root.'
    @scored = true
    @level = 1
    @identifier = 'SV_238339r654192'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238339r654192.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238339r654192.sh"}]
  end
end
