...
class STIG_Ubuntu2004_SV_238290r654045 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238290r654045')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the gpasswd command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238290r654045'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238290r654045.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238290r654045.sh"}]
  end
end
