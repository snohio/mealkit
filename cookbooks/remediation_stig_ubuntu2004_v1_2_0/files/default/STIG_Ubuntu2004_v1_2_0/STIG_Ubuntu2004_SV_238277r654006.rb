...
class STIG_Ubuntu2004_SV_238277r654006 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238277r654006')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the sudo command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238277r654006'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238277r654006.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238277r654006.sh"}]
  end
end
