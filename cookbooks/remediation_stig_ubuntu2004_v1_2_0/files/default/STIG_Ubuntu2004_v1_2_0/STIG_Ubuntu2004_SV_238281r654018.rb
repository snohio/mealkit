...
class STIG_Ubuntu2004_SV_238281r654018 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238281r654018')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the chcon command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238281r654018'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238281r654018.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238281r654018.sh"}]
  end
end
