...
class STIG_Ubuntu2004_SV_238250r653925 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238250r653925')
    @title = 'The Ubuntu operating system must permit only authorized accounts to own the audit configuration files.'
    @scored = true
    @level = 1
    @identifier = 'SV_238250r653925'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238250r653925.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238250r653925.sh"}]
  end
end
