...
class STIG_Ubuntu2004_SV_238279r654012 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238279r654012')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the chsh command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238279r654012'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238279r654012.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238279r654012.sh"}]
  end
end
