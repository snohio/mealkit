...
class STIG_Ubuntu2004_SV_238256r653943 < CISRemediation
  def initialize
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238256r653943.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238256r653943.sh"}]
  end
end
