...
class STIG_Ubuntu2004_SV_238291r654048 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238291r654048')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the chage command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238291r654048'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238291r654048.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238291r654048.sh"}]
  end
end
