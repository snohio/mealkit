...
class STIG_Ubuntu2004_SV_238288r654039 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238288r654039')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the passwd command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238288r654039'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238288r654039.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238288r654039.sh"}]
  end
end
