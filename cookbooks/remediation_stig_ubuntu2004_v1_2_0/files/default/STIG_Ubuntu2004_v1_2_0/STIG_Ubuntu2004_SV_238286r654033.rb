...
class STIG_Ubuntu2004_SV_238286r654033 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238286r654033')
    @title = 'The Ubuntu operating system must generate audit records for the use and modification of faillog file.'
    @scored = true
    @level = 1
    @identifier = 'SV_238286r654033'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238286r654033.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238286r654033.sh"}]
  end
end
