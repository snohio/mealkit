...
class STIG_Ubuntu2004_SV_238342r654201 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238342r654201')
    @title = 'The Ubuntu operating system must configure /var/log/syslog file to be owned by syslog.'
    @scored = true
    @level = 1
    @identifier = 'SV_238342r654201'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238342r654201.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238342r654201.sh"}]
  end
end
