...
class STIG_Ubuntu2004_SV_238320r654135 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238320r654135')
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238320r654135.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238320r654135.sh"}]
  end
end
