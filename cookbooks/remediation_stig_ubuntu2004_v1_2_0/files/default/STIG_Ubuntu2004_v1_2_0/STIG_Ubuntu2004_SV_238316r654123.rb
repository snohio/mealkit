...
class STIG_Ubuntu2004_SV_238316r654123 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238316r654123')
    @title = 'The Ubuntu operating system must generate audit records for the /var/run/wtmp file.'
    @scored = true
    @level = 1
    @identifier = 'SV_238316r654123'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238316r654123.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238316r654123.sh"}]
  end
end
