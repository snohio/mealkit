...
class STIG_Ubuntu2004_SV_238293r654054 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238293r654054')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the crontab command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238293r654054'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238293r654054.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238293r654054.sh"}]
  end
end
