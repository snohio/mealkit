...
class STIG_Ubuntu2004_SV_238253r653934 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238253r653934')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the chfn command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238253r653934'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238253r653934.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238253r653934.sh"}]
  end
end
