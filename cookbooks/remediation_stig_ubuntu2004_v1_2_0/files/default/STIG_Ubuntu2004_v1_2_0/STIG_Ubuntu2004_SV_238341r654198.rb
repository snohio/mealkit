...
class STIG_Ubuntu2004_SV_238341r654198 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238341r654198')
    @title = 'The Ubuntu operating system must configure the /var/log/syslog file to be group-owned by adm.'
    @scored = true
    @level = 1
    @identifier = 'SV_238341r654198'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238341r654198.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238341r654198.sh"}]
  end
end
