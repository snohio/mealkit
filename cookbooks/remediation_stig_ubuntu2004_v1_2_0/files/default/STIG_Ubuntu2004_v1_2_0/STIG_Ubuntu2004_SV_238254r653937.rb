...
class STIG_Ubuntu2004_SV_238254r653937 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238254r653937')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the mount command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238254r653937'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238254r653937.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238254r653937.sh"}]
  end
end
