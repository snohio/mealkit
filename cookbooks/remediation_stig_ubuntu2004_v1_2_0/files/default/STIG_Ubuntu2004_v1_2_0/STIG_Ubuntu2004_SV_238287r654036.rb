...
class STIG_Ubuntu2004_SV_238287r654036 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238287r654036')
    @title = 'The Ubuntu operating system must generate audit records for the use and modification of the lastlog file.'
    @scored = true
    @level = 1
    @identifier = 'SV_238287r654036'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238287r654036.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238287r654036.sh"}]
  end
end
