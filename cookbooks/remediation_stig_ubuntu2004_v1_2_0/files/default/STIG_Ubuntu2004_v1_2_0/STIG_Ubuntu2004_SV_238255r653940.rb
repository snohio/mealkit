...
class STIG_Ubuntu2004_SV_238255r653940 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238255r653940')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the umount command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238255r653940'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238255r653940.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238255r653940.sh"}]
  end
end
