...
class STIG_Ubuntu2004_SV_238315r654120 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238315r654120')
    @title = 'The Ubuntu operating system must generate audit records for the /var/log/wtmp file.'
    @scored = true
    @level = 1
    @identifier = 'SV_238315r654120'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238315r654120.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238315r654120.sh"}]
  end
end
