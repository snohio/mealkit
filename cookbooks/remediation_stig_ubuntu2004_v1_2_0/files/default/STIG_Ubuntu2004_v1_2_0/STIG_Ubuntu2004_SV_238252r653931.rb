...
class STIG_Ubuntu2004_SV_238252r653931 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238252r653931')
    @title = 'The Ubuntu operating system must generate audit records for successful/unsuccessful uses of the su command.'
    @scored = true
    @level = 1
    @identifier = 'SV_238252r653931'
    @description = '
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238252r653931.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238252r653931.sh"}]
  end
end
