...
class STIG_Ubuntu2004_SV_238264r808477 < CISRemediation
  def initialize
    super('STIG_Ubuntu2004_SV_238264r808477')
    ...
    '
    @script_file = 'STIG_Ubuntu2004_SV_238264r808477.sh'
    @commands = [{"script_bash"=>"bash #{@script_directory}/STIG_Ubuntu2004_SV_238264r808477.sh"}]
  end
end
